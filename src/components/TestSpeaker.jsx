...
const Card = ({ id, name, image, index, onClick }) => {
  ...
  return (
    <motion.div
      ...
      className="relative w-[200px] h-[300px] rounded-tl-[100px] overflow-hidden mx-auto sm:mx-2 cursor-pointer"
      onClick={onClick}
    >
      ...
      <div className="absolute bottom-4 left-4 z-20 text-white leading-tight">
        <p className="text-xl font-serif">{firstName}</p>
